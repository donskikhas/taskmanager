    ...
    <div className="max-w-3xl mx-auto w-full pt-8">
      <div className="flex items-center justify-between mb-6">
        ...
        <button 
            ...
            className="text-sm text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 flex items-center gap-1 px-3 py-1.5 rounded hover:bg-gray-100 dark:hover:bg-notion-dark-hover transition-colors"
        >
      ...
      <div className="bg-white dark:bg-notion-dark-sidebar border border-gray-200 dark:border-notion-dark-border rounded-xl shadow-sm overflow-hidden">
        {activities.length === 0 ? (
            ...
            <div className="divide-y divide-gray-100 dark:divide-gray-800">
                {activities.map(log => (
                    <div key={log.id} className={`p-4 flex gap-4 transition-colors ${!log.read ? 'bg-blue-50/50 dark:bg-blue-900/10' : 'hover:bg-gray-50 dark:hover:bg-notion-dark-hover'}`}>
                        <div className="mt-1">
                             {log.userAvatar ? (
                                 <img src={log.userAvatar} className="w-8 h-8 rounded-full border border-gray-200 dark:border-gray-600" alt="" />
                             ) : (
